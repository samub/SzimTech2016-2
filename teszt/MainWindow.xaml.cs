        ...
        private async void ButtonStart_Click(object sender, RoutedEventArgs e) {
            ...
            if (_robot != null) {
                ...
                else if (RadioButtonHeuristic2.IsChecked != null && RadioButtonHeuristic2.IsChecked.Value)
                {
                    ...
                    _mapcover.fullmapkiir();
                    _creategraph.creatcoor(_mapcover.getNumber(), _mapcover.fullmap);
                    //_creategraph.coormapkiir(_mapcover.getNumber());
                    ...
                    _creategraph.kiir(_mapcover.getNumber());

                    foreach (var t in _creategraph.tspList)
                    {
                    ...
                    /*int a = 0;
                    int b = 0;
                    foreach (var n in _creategraph.tspList)
                    {

                        _creategraph.bresenHam(a, b, n.Item1, n.Item2);
                        a = n.Item1;
                        b = n.Item2;
                    }

                    foreach (var n in _creategraph.coordinatesList)
                    {
                        _robot.Route.Add(new Tuple<int, int, double>(n.Item1, n.Item2, 0));
                    }
