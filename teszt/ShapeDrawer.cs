...
namespace RobotMover {
    internal static class ShapeDrawer {
        public static void DrawCircle(int x0, int y0, int radius, ref byte[] pixels) {
            ...
            while (x >= y) {
                if (x0 + x >= 0 && x0 + x <= 640 - 1 && y0 + y >= 0 && y0 + y <= 640 - 1) DrawPixel(x + x0, y + y0, ref pixels, false);
                if (x0 + x >= 0 && x0 + x <= 640 - 1 && y0 - y >= 0 && y0 - y <= 640 - 1) DrawPixel(x + x0, -y + y0, ref pixels, false);
                if (x0 - x >= 0 && x0 - x <= 640 - 1 && y0 + y >= 0 && y0 + y <= 640 - 1) DrawPixel(-x + x0, y + y0, ref pixels, false);
                if (x0 - x >= 0 && x0 - x <= 640 - 1 && y0 - y >= 0 && y0 - y <= 640 - 1) DrawPixel(-x + x0, -y + y0, ref pixels, false);
                if (x0 + y >= 0 && x0 + y <= 640 - 1 && y0 + x >= 0 && y0 + x <= 640 - 1) DrawPixel(y + x0, x + y0, ref pixels, false);
                if (x0 + y >= 0 && x0 + y <= 640 - 1 && y0 - x >= 0 && y0 - x <= 640 - 1) DrawPixel(y + x0, -x + y0, ref pixels, false);
                if (x0 - y >= 0 && x0 - y <= 640 - 1 && y0 + x >= 0 && y0 + x <= 640 - 1) DrawPixel(-y + x0, x + y0, ref pixels, false);
                if (x0 - y >= 0 && x0 - y <= 640 - 1 && y0 - x >= 0 && y0 - x <= 640 - 1) DrawPixel(-y + x0, -x + y0, ref pixels, false);
                y++;
        ...
        public static void DrawEllipse(int xc, int yc, int width, int height, ref byte[] pixels) {
            ...
            for (x = 0, y = height, sigma = 2 * b2 + a2 * (1 - 2 * height); b2 * x <= a2 * y; x++) {
                if (xc + x >= 0 && xc + x <= 640 - 1 && yc + y >= 0 && yc + y <= 640 - 1) DrawPixel(xc + x, yc + y, ref pixels, false);
                if (xc - x >= 0 && xc - x <= 640 - 1 && yc + y >= 0 && yc + y <= 640 - 1) DrawPixel(xc - x, yc + y, ref pixels, false);
                if (xc + x >= 0 && xc + x <= 640 - 1 && yc - y >= 0 && yc - y <= 640 - 1) DrawPixel(xc + x, yc - y, ref pixels, false);
                if (xc - x >= 0 && xc - x <= 640 - 1 && yc - y >= 0 && yc - y <= 640 - 1) DrawPixel(xc - x, yc - y, ref pixels, false);
                if (sigma >= 0) {
        ...
        public static void DrawRectangle(int x, int y, int length, int breadth, ref byte[] pixels, bool color) {
            DrawLine(x - breadth / 2, y + length / 2, x + breadth / 2, y + length / 2, ref pixels, color);
            DrawLine(x + breadth / 2, y + length / 2, x + breadth / 2, y - length / 2, ref pixels, color);
            DrawLine(x + breadth / 2, y - length / 2, x - breadth / 2, y - length / 2, ref pixels, color);
            DrawLine(x - breadth / 2, y - length / 2, x - breadth / 2, y + length / 2, ref pixels, color);
        }
        ...
        private static void CirclePoints(int x, int y, int xc, int yc, double startangle, double endangle,
            ...
            if (CanDraw(90 - theta, startangle, endangle) && xc + y >= 0 && xc + y <= 640 - 1 && yc - x >= 0 &&
                yc - x <= 640 - 1) DrawPixel(xc + y, yc - x, ref pixels, color);
        ...
        public static void FloodFill(ref byte[] pixels, Point pt, bool color) {
            ...
            while (q.Count > 0) {
                ...
                while ((w.X >= 0) && pixels[(int) (w.X * 4 + w.Y * 4 * 640)] != 255) {
                    DrawPixel((int) w.X, (int) w.Y, ref pixels, color);
                ...
                while ((e.X <= 640 - 1) && pixels[(int) (e.X * 4 + e.Y * 4 * 640)] != 255) {
                    DrawPixel((int) e.X, (int) e.Y, ref pixels, color);
        ...
        public static void DrawCircle(int x0, int y0, int radius, double startangle, double endangle, ref byte[] pixels,
            ...
            while (x >= y) {
                CirclePoints(x, y, x0, y0, startangle, endangle, ref pixels, color);
                y++;
                if (decisionOver2 <= 0) decisionOver2 += 2 * y + 1;
                else {
                    x--;
        ...
        public static void DrawLine(int x0, int y0, int x1, int y1, ref byte[] pixels, bool color) {
            ...
            for (var x = x0; x <= x1; ++x) {
                if (steep) {
                    if (x >= 0 && x <= 640 - 1 && y >= 0 && y <= 640 - 1) DrawPixel(y, x, ref pixels, color);
                    if (x >= 0 && x <= 640 - 1 && y >= 0 && y <= 640 - 1) DrawPixel(y, x, ref pixels, color);
                    if (x >= 0 && x <= 640 - 1 && y >= 0 && y <= 640 - 1) DrawPixel(y, x, ref pixels, color);
                    if (x >= 0 && x <= 640 - 1 && y >= 0 && y <= 640 - 1) DrawPixel(y, x, ref pixels, color);
                    if (y >= 0 && y <= 640 - 1 && x >= 0 && x <= 640 - 1) DrawPixel(y, x, ref pixels, color);
                    if (y >= 0 && y <= 640 - 1 && x >= 0 && x <= 640 - 1) DrawPixel(y, x, ref pixels, color);
                    if (y >= 0 && y <= 640 - 1 && x >= 0 && x <= 640 - 1) DrawPixel(y, x, ref pixels, color);
                    if (y >= 0 && y <= 640 - 1 && x >= 0 && x <= 640 - 1) DrawPixel(y, x, ref pixels, color);
                }
                else {
                    if (x >= 0 && x <= 640 - 1 && y >= 0 && y <= 640 - 1) DrawPixel(x, y, ref pixels, color);
                    if (x >= 0 && x <= 640 - 1 && y >= 0 && y <= 640 - 1) DrawPixel(x, y, ref pixels, color);
                    if (x >= 0 && x <= 640 - 1 && y >= 0 && y <= 640 - 1) DrawPixel(x, y, ref pixels, color);
                    if (x >= 0 && x <= 640 - 1 && y >= 0 && y <= 640 - 1) DrawPixel(x, y, ref pixels, color);
                    if (y >= 0 && y <= 640 - 1 && x >= 0 && x <= 640 - 1) DrawPixel(x, y, ref pixels, color);
                    if (y >= 0 && y <= 640 - 1 && x >= 0 && x <= 640 - 1) DrawPixel(x, y, ref pixels, color);
                    if (y >= 0 && y <= 640 - 1 && x >= 0 && x <= 640 - 1) DrawPixel(x, y, ref pixels, color);
                    if (y >= 0 && y <= 640 - 1 && x >= 0 && x <= 640 - 1) DrawPixel(x, y, ref pixels, color);
                }
